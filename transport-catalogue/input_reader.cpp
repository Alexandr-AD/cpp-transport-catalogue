...
catalogueInput::CommandDescription ParseCommandDescription(std::string_view line)
{
...
void catalogueInput::InputReader::ParseLine(std::string_view line)
{
...
void catalogueInput::InputReader::ApplyCommands([[maybe_unused]] TransportCatalogue &catalogue) const
{
